(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PostDetailComponent = /** @class */ (function () {
                ...
                PostDetailComponent.prototype.getMapUrl = function (longitude, latitude) {
                    return (this.mapUrl +
                        latitude +
                        "," +
                        longitude +
                ...
                PostDetailComponent.prototype.editPost = function (postId) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PostListComponent = /** @class */ (function () {
                function PostListComponent(postService, router, datePipe, confirmationModalService, alertService) {
                    var _this = this;
                    this.postService = postService;
                    this.router = router;
                    ...
                    postService.getPosts().subscribe(function (response) {
                        _this.rows = _this.transformDataToTable(response);
                    });
                }
                PostListComponent.prototype.ngOnInit = function () { };
                PostListComponent.prototype.goToCreatePostView = function () {
                    this.router.navigate(["/posts/new"]);
                };
                PostListComponent.prototype.transformDate = function (date) {
                    return this.datePipe.transform(date, "dd/MM/yyyy");
                };
                PostListComponent.prototype.transformDataToTable = function (posts) {
                    var response = [];
                    for (var i in posts) {
                        var post = posts[i];
                        var geoposition = post.long ? post.long + "," + post.lat : "";
                        var row = {
                            id: post.id,
                            title: post.title,
                ...
                PostListComponent.prototype.deletePost = function (postIndex) {
                    this.postToDeleteIndex = postIndex;
                    this.confirmationModalService.showModal();
                };
                PostListComponent.prototype.confirmDeletePost = function () {
                    var _this = this;
                    this.postService
                        .deletePost(this.rows[this.postToDeleteIndex].id)
                        .subscribe(function (response) {
                        _this.alertService.showAlert('success', 'Post deleted successfully');
                        _this.rows.splice(_this.postToDeleteIndex, 1);
                        _this.confirmationModalService.hideModal();
                    }, function (error) {
                        _this.alertService.showAlert('error', 'Error deleting post: ' + error);
                    });
                };
                PostListComponent.prototype.goToDetail = function (id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PostUpdateComponent = /** @class */ (function () {
                function PostUpdateComponent(route, postService, formBuilder, router, alertService) {
                    this.route = route;
                    this.postService = postService;
                ...
                PostUpdateComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.params.subscribe(function (params) {
                        ...
                        if (id) {
                            ...
                            return _this.postService.getPost(Number(id)).subscribe(function (response) {
                                _this.originalPost = Object.assign({}, response);
                                delete response.id;
                                delete response.created_at;
                                delete response.updated_at;
                                _this.registerForm.setValue(response);
                            }, function (error) {
                                _this.alertService.showAlert("error", "Error getting post data!");
                            });
                        }
                    });
                };
                PostUpdateComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.submitted = true;
                    if (this.registerForm.invalid) {
                        ...
                        if (!this.isCreate) {
                            ...
                            successMessage_1 = "Post updated successfully!";
                            errorMessage_1 = "Error updating post!";
                        }
                        else {
                            obs = this.createPost(this.registerForm.value);
                            successMessage_1 = "Post created successfully!";
                            errorMessage_1 = "Error creating post!";
                        }
                        obs.subscribe(function (response) {
                            _this.alertService.showAlert("success", successMessage_1);
                            _this.router.navigate(["/posts"]);
                        }, function (error) {
                            _this.alertService.showAlert("error", errorMessage_1);
                        });
                    }
                };
                PostUpdateComponent.prototype.createPost = function (post) {
                    return this.postService.createPost(post);
                };
                PostUpdateComponent.prototype.updatePost = function (id, post) {
                    post.id = id;
                    return this.postService.updatePost(id, post);
                };
                PostUpdateComponent.prototype.getMapUrl = function (longitude, latitude) {
                    return (this.mapUrl +
                        latitude +
                        "," +
                        longitude +
                ...
                PostUpdateComponent.prototype.back = function () {
                    this.router.navigate(["/posts/detail", this.originalPost.id]);
                };
                return PostUpdateComponent;
            }());
            PostUpdateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NavbarComponent = /** @class */ (function () {
                ...
                NavbarComponent.prototype.navigateTo = function (url) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TableComponent = /** @class */ (function () {
                ...
                TableComponent.prototype.deleteElement = function (index) {
                };
                TableComponent.prototype.executeFirstAction = function (index) {
                    this.action1.emit(index);
                };
                TableComponent.prototype.executeSecondAction = function (row) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AlertService = /** @class */ (function () {
                ...
                AlertService.prototype.isAlertVisible = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ConfirmationModalService = /** @class */ (function () {
                ...
                ConfirmationModalService.prototype.showModal = function () {
                    this.modalVisible = true;
                };
                ConfirmationModalService.prototype.hideModal = function () {
                    this.modalVisible = false;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PostService = /** @class */ (function () {
                ...
                PostService.prototype.updatePost = function (postId, newValue) {
